...
function showAlert(message, theClassName) {
  //Create div
  var div = document.createElement('div'); //Add Classes

  div.className = "alert alert-".concat(theClassName); //Add text
...
function fetchAnimals(e) {
  ...
  if (!(0, _validate.isValidZip)(zip)) {
    (0, _validate.showAlert)('Please Enter A Valid Zipcode from US or CA', 'danger');
  } //Fetch Pets


  (0, _fetchJsonp.default)("http://api.petfinder.com/pet.find?format=json&key=2a10c1aaa237f5820ec58e71e0a88f8e&animal=".concat(animal, "&location=").concat(zip, "&callback=callback"), {
...
function showAnimals(pets) {
  var results = document.querySelector('#result'); //Clear results first
  ...
  pets.forEach(function (pet) {
    ...
    div.innerHTML = "\n            <div class=\"row\">\n                <div class=\"col-sm-6\">\n                    <h4>".concat(pet.name.$t, " (").concat(pet.age.$t, ")</h4>\n                    <p class=\"text-secondary\">").concat(pet.breeds.breed.$t, "</p>\n                    <p class=\"text-secondary\">").concat(pet.contact.address1.$t, " ").concat(pet.contact.city.$t, " ").concat(pet.contact.state.$t, " ").concat(pet.contact.zip.$t, "</p>\n                    <ul class=\"list-group\">\n                        <li class=\"list-group-item\">Phone: ").concat(pet.contact.phone.$t, " </li>\n                        ").concat(pet.contact.email.$t ? "<li class=\"list-group-item\">Email: ".concat(pet.contact.email.$t, " </li>") : "", "\n                        <li class=\"list-group-item\">Shelter ID: ").concat(pet.shelterId.$t, " </li>\n                    </ul>\n                </div>\n\n                <div class=\"col-sm-6 text-center\">\n                    <img class=\"img-fluid rounded mt-2\" src=\"").concat(pet.media.photos.photo[3].$t, "\">\n                </div>\n            </div>\n        ");
    results.appendChild(div);
  });
}
},{"fetch-jsonp":"node_modules/fetch-jsonp/build/fetch-jsonp.js","./validate":"src/validate.js"}],"../../../Users/syoncode/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../Users/syoncode/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.js"], null)
